...
void MainPage::resized()
{
  ...
  speed.setBounds(centerX - SPEEDOMETER_WIDTH - SPEEDOMETER_OFFSET, centerY - SPEEDOMETER_HEIGHT / 2, SPEEDOMETER_WIDTH, SPEEDOMETER_HEIGHT);
  wind.setBounds(centerX + SPEEDOMETER_OFFSET, centerY - SPEEDOMETER_HEIGHT / 2, SPEEDOMETER_WIDTH, SPEEDOMETER_HEIGHT);
